...
import {LimitedAccessControl} from "@summerfi/access-contracts/contracts/LimitedAccessControl.sol";
 ...
 */
contract ProtocolAccessManagerWhitelist is
    IProtocolAccessManagerWhitelist,
    LimitedAccessControl
{
    ...
    /// @inheritdoc IProtocolAccessManagerWhitelist
    function grantWhitelistedRole(
        address fleetCommanderAddress,
        address account
    ) external onlyGovernor {
        bytes32 role = generateRole(
    ...
    /// @inheritdoc IProtocolAccessManagerWhitelist
    function revokeWhitelistedRole(
        address fleetCommanderAddress,
        address account
    ) external onlyGovernor {
        bytes32 role = generateRole(
