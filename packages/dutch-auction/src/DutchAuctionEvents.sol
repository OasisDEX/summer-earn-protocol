...
/**
 * @title Dutch Auction Events
 * @notice This contract defines events for the Dutch Auction system
 */
contract DutchAuctionEvents {
    ...
    /**
     * @notice Emitted when tokens are purchased in an auction
    ...
    /**
     * @notice Emitted when the kicker reward is claimed
     * @param auctionId The unique identifier of the auction
