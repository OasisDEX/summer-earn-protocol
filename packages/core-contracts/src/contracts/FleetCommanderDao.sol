...
import {FleetCommanderConfigProviderDao} from "./FleetCommanderConfigProviderDao.sol";
...
/**
 * @title FleetCommanderDao
 * @notice Manages a fleet of Arks, coordinating deposits, withdrawals, and rebalancing operations
 * @dev Implements IFleetCommanderDao interface and inherits from various utility contracts
 */
contract FleetCommanderDao is
    IFleetCommanderDao,
    FleetCommanderConfigProviderDao,
    ERC4626,
    Tipper,
    FleetCommanderCache,
    CooldownEnforcer
{
    ...
    function totalAssets()
        public
        view
        override(IFleetCommanderDao, ERC4626)
        returns (uint256)
    {
