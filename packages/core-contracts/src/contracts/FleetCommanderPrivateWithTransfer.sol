...
import {IFleetCommanderPrivateWithTransfer} from "../interfaces/IFleetCommanderPrivateWithTransfer.sol";
 ...
 */
contract FleetCommanderPrivateWithTransfer is
    ...
    FleetCommanderCache
{
    ...
    function totalAssets()
        public
        view
        override(IFleetCommanderPrivateWithTransfer, ERC4626)
        returns (uint256)
    {
