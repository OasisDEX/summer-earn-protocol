...
/**
 * @title FleetCommanderConfigProviderDao
 * @author SummerFi
 * @notice This contract provides configuration management for the FleetCommanderConfigProviderDao
 * @custom:see IFleetCommanderConfigProviderDao
 */
contract FleetCommanderConfigProviderDao is
    ...
    IFleetCommanderConfigProviderDao
{
    ...
    ///@inheritdoc IFleetCommanderConfigProviderDao
    function setArkDepositCapToZero(
        address ark
    ) external onlyGuardian onlyActiveArk(ark) whenNotPaused {
        IArk(ark).setDepositCap(0);
    }
    ...
    ///@inheritdoc IFleetCommanderConfigProviderDao
    function setFleetDepositCapToZero() external onlyGuardian whenNotPaused {
        config.depositCap = 0;
        emit FleetCommanderDepositCapUpdated(0);
    }
