...
interface ITipJar is ITipJarEvents {
    ...
    function addTipStream(address recipient, uint256 allocation, uint256 minimumTerm) external;
    function removeTipStream(address recipient) external;
    function updateTipStream(address recipient, uint256 newAllocation, uint256 newMinimumTerm) external;
