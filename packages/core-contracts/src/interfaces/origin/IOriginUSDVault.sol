...
/// @title IOriginUSDVault
/// @notice Interface for the Origin USD vault, handling minting and queued withdrawals of OUSD
interface IOriginUSDVault {
    ...
    /// @param amount The amount of oTokens to redeem (e.g. OUSD)
    ...
    struct WithdrawalRequest {
        ...
        // Amount of oTokens to redeem. eg OUSD
        uint128 amount;
    ...
    /// @notice Mints OUSD by depositing the underlying asset
    /// @param to The address of the asset deposited to mint OUSD
    /// @param amount The amount of the asset to deposit
    /// @param minShares The minimum amount of OUSD to mint (slippage protection)
    ...
    /// @param amount The amount of OUSD to redeem
