...
contract SyrupArkV2TestFork is Test, IArkEvents, ArkTestBase {
    ...
    function test_RequestPartialRedeem_Syrup_fork() public {
        ...
        uint256 sharesAmount = ISyrupPool(SYRUP_USDC_POOL_ADDRESS).convertToExitShares(withdrawalAmount);
        vm.expectCall(
    ...
    function test_WithdrawableTotalAssets_Syrup_fork() public {
        ...
        assertEq(IERC20(USDC_ADDRESS).balanceOf(bufferArk), bufferArkUsdcBalanceBefore + withdrawalAmount);
    }
