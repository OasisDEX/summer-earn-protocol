...
contract SyrupArkV2USDTTestFork is Test, IArkEvents, ArkTestBase {
    ...
    address public constant SYRUP_USDT_POOL_ADDRESS = 0x356B8d89c1e1239Cbbb9dE4815c39A1474d5BA7D;
    address public constant USDT_ADDRESS = 0xdAC17F958D2ee523a2206206994597C13D831ec7;
    address public constant SYRUP_USDT_ROUTER_ADDRESS = 0xF007476Bb27430795138C511F18F821e8D1e5Ee2;
    address public constant SYRUP_USDT_POOL_MANAGER_ADDRESS = 0x0cdA32E08B48bFDDbc7eE96B44b09cf286F9E21a;
    address public constant SYRUP_POOL_PERMISSION_MANAGER = 0xBe10aDcE8B6E3E02Db384E7FaDA5395DD113D8b3;
    address public constant SYRUP_USDT_WITHDRAWAL_MANAGER_ADDRESS = 0x86eBDf902d800F2a82038290B6DBb2A5eE29eB8C;
    ...
    function setUp() public {
        ...
        (address _commander, address _bufferArk) = setupFleetCommanderWithBufferArk(USDT_ADDRESS, "Test Fleet");
        ...
        withdrawalManager = IMapleWithdrawalManager(SYRUP_USDT_WITHDRAWAL_MANAGER_ADDRESS);
        ...
        ark = new SyrupArkV2(address(syrupPool), SYRUP_USDT_ROUTER_ADDRESS, params);
        ...
        IPoolPermissionManager(SYRUP_POOL_PERMISSION_MANAGER)
            .setLenderAllowlist(SYRUP_USDT_POOL_MANAGER_ADDRESS, lenders, booleans);
        vm.stopPrank();
    ...
    function test_Board_Syrup_fork() public {
        ...
        uint256 shares = ISyrupPool(SYRUP_USDT_POOL_ADDRESS).convertToShares(amount);
    ...
    function test_RequestPartialRedeem_Syrup_fork() public {
        ...
        uint256 sharesAmount = ISyrupPool(SYRUP_USDT_POOL_ADDRESS).convertToExitShares(withdrawalAmount);
        vm.expectCall(
    ...
    function test_WithdrawableTotalAssets_Syrup_fork() public {
        ...
        uint256 bufferArkUsdtBalanceBefore = IERC20(USDT_ADDRESS).balanceOf(bufferArk);
        vm.expectEmit(true, true, true, true);
        emit Disembarked(address(keeper), USDT_ADDRESS, withdrawalAmount);

        vm.prank(keeper);
        ark.sweep();

        assertEq(IERC20(USDT_ADDRESS).balanceOf(bufferArk), bufferArkUsdtBalanceBefore + withdrawalAmount);
    }
    ...
    function test_WithdrawableTotalAssets_Syrup_maxuint_fork() public {
        ...
        assertEq(IERC20(USDT_ADDRESS).balanceOf(bufferArk), bufferArkUsdtBalanceBefore + amount - 1);
    }
    ...
    function test_RequestWithdrawal_MaxUint() public {
        ...
        assertGt(IERC20(address(syrupPool)).balanceOf(address(ark)), 0, "There should be syrupUSDT in the ark");
        ...
        assertEq(IERC20(address(syrupPool)).balanceOf(address(ark)), 0, "There should be no syrupUSDT in the ark");
    }
