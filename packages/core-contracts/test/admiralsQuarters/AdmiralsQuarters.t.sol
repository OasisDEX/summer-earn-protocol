...
contract AdmiralsQuartersTest is FleetCommanderTestBase, OneInchTestHelpers {
    ...
    //     // uint256 simulatedSharesAmount2 = wethFleet.previewDeposit(wethAmount); // Unused variable
    ...
    function test_RewardsExploitViaStakeOnBehalfOf() public {
        ...
        vm.startPrank(user1);
        IERC20(USDC_ADDRESS).approve(address(usdcFleet), usdcAmount);
        // uint256 user1shares = usdcFleet.deposit(usdcAmount, user1); // Unused variable
    ...
    function test_RemoveRewardToken_FailsWithTooMuchBalance() public {
        ...
        // uint256 rewardAmount = 100e18; // Unused variable
        // uint256 rewardDuration = 10 days; // Unused variable
    ...
    function test_RemoveRewardToken_SucceedsWithDust() public {
        ...
        // uint256 rewardAmount = 54e18; // Unused variable
