...
contract SummerGovernorEIP712Test is SummerGovernorV2TestBase {
    ...
    function test_EIP712Domain() public view {
        ...
        assertEq(name, "SummerGovernorV2");
        assertEq(version, "1");
        ...
        return
            keccak256(
                abi.encode(
                    ...
                    keccak256(bytes("SummerGovernorV2")),
                    keccak256(bytes("1")),
                    block.chainid,
                    address(governorA)
                )
    ...
    function test_GetVotes() public {
        ...
        stakeAndGetXSumr(alice, 100e18, true);
    ...
    function test_VotingPowerIntegration() public {
        ...
        stakeAndGetXSumr(alice, votingPower, true);
