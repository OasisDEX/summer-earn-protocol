...
export class FeedRegistry__getPhaseResultPhaseStruct extends ethereum.Tuple {
  get phaseId(): i32 {
    return this[0].toI32()
  }
...
export class FeedRegistry__getPhaseRangeResult {
  value0: BigInt
  value1: BigInt
...
export class FeedRegistry__getRoundDataResult {
  value0: BigInt
  value1: BigInt
  value2: BigInt
  value3: BigInt
...
export class FeedRegistry__latestRoundDataResult {
  value0: BigInt
  value1: BigInt
  value2: BigInt
  value3: BigInt
...
export class FeedRegistry__proposedGetRoundDataResult {
  value0: BigInt
  value1: BigInt
  value2: BigInt
  value3: BigInt
...
export class FeedRegistry__proposedLatestRoundDataResult {
  value0: BigInt
  value1: BigInt
  value2: BigInt
  value3: BigInt
...
export class FeedRegistry extends ethereum.SmartContract {
  ...
  try_decimals(base: Address, quote: Address): ethereum.CallResult<i32> {
    let result = super.tryCall('decimals', 'decimals(address,address):(uint8)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
  ...
  description(base: Address, quote: Address): string {
    let result = super.call('description', 'description(address,address):(string)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
  ...
  try_description(base: Address, quote: Address): ethereum.CallResult<string> {
    let result = super.tryCall('description', 'description(address,address):(string)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
  ...
  getAccessController(): Address {
    let result = super.call('getAccessController', 'getAccessController():(address)', [])

    return result[0].toAddress()
  }

  try_getAccessController(): ethereum.CallResult<Address> {
    let result = super.tryCall('getAccessController', 'getAccessController():(address)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  getAnswer(base: Address, quote: Address, roundId: BigInt): BigInt {
    let result = super.call('getAnswer', 'getAnswer(address,address,uint256):(int256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
  ...
  try_getAnswer(base: Address, quote: Address, roundId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall('getAnswer', 'getAnswer(address,address,uint256):(int256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
      ethereum.Value.fromUnsignedBigInt(roundId),
    ])
  ...
  getCurrentPhaseId(base: Address, quote: Address): i32 {
    let result = super.call('getCurrentPhaseId', 'getCurrentPhaseId(address,address):(uint16)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
  ...
  try_getCurrentPhaseId(base: Address, quote: Address): ethereum.CallResult<i32> {
    let result = super.tryCall('getCurrentPhaseId', 'getCurrentPhaseId(address,address):(uint16)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
  ...
  try_getFeed(base: Address, quote: Address): ethereum.CallResult<Address> {
    let result = super.tryCall('getFeed', 'getFeed(address,address):(address)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
  ...
  getNextRoundId(base: Address, quote: Address, roundId: BigInt): BigInt {
    let result = super.call('getNextRoundId', 'getNextRoundId(address,address,uint80):(uint80)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
      ethereum.Value.fromUnsignedBigInt(roundId),
    ])
  ...
  try_getNextRoundId(base: Address, quote: Address, roundId: BigInt): ethereum.CallResult<BigInt> {
  ...
  getPhase(base: Address, quote: Address, phaseId: i32): FeedRegistry__getPhaseResultPhaseStruct {
    ...
    return changetype<FeedRegistry__getPhaseResultPhaseStruct>(result[0].toTuple())
  }
  ...
  try_getPhase(
    ...
    quote: Address,
    phaseId: i32,
  ): ethereum.CallResult<FeedRegistry__getPhaseResultPhaseStruct> {
    let result = super.tryCall(
      'getPhase',
      'getPhase(address,address,uint16):((uint16,uint80,uint80))',
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<FeedRegistry__getPhaseResultPhaseStruct>(value[0].toTuple()),
    )
  }

  getPhaseFeed(base: Address, quote: Address, phaseId: i32): Address {
    let result = super.call('getPhaseFeed', 'getPhaseFeed(address,address,uint16):(address)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(phaseId)),
    ])
  ...
  try_getPhaseFeed(base: Address, quote: Address, phaseId: i32): ethereum.CallResult<Address> {
    let result = super.tryCall('getPhaseFeed', 'getPhaseFeed(address,address,uint16):(address)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(phaseId)),
    ])
  ...
  getPhaseRange(base: Address, quote: Address, phaseId: i32): FeedRegistry__getPhaseRangeResult {
    let result = super.call(
      'getPhaseRange',
    ...
    return new FeedRegistry__getPhaseRangeResult(result[0].toBigInt(), result[1].toBigInt())
  }
  ...
  try_getPhaseRange(
    ...
    quote: Address,
    phaseId: i32,
  ): ethereum.CallResult<FeedRegistry__getPhaseRangeResult> {
    let result = super.tryCall(
      'getPhaseRange',
      'getPhaseRange(address,address,uint16):(uint80,uint80)',
      [
    ...
    let value = result.value
    return ethereum.CallResult.fromValue(
      new FeedRegistry__getPhaseRangeResult(value[0].toBigInt(), value[1].toBigInt()),
    )
  }
  ...
  getProposedFeed(base: Address, quote: Address): Address {
    let result = super.call('getProposedFeed', 'getProposedFeed(address,address):(address)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
  ...
  try_getProposedFeed(base: Address, quote: Address): ethereum.CallResult<Address> {
    let result = super.tryCall('getProposedFeed', 'getProposedFeed(address,address):(address)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
  ...
  getRoundData(base: Address, quote: Address, _roundId: BigInt): FeedRegistry__getRoundDataResult {
    let result = super.call(
      'getRoundData',
    ...
    return new FeedRegistry__getRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getRoundData(
    ...
    quote: Address,
    _roundId: BigInt,
  ): ethereum.CallResult<FeedRegistry__getRoundDataResult> {
    let result = super.tryCall(
      'getRoundData',
      'getRoundData(address,address,uint80):(uint80,int256,uint256,uint256,uint80)',
      [
    ...
    let value = result.value
    return ethereum.CallResult.fromValue(
      new FeedRegistry__getRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getRoundFeed(base: Address, quote: Address, roundId: BigInt): Address {
    let result = super.call('getRoundFeed', 'getRoundFeed(address,address,uint80):(address)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
      ethereum.Value.fromUnsignedBigInt(roundId),
    ])
  ...
  try_getRoundFeed(base: Address, quote: Address, roundId: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall('getRoundFeed', 'getRoundFeed(address,address,uint80):(address)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
      ethereum.Value.fromUnsignedBigInt(roundId),
    ])
  ...
  getTimestamp(base: Address, quote: Address, roundId: BigInt): BigInt {
    let result = super.call('getTimestamp', 'getTimestamp(address,address,uint256):(uint256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
      ethereum.Value.fromUnsignedBigInt(roundId),
    ])
  ...
  try_getTimestamp(base: Address, quote: Address, roundId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall('getTimestamp', 'getTimestamp(address,address,uint256):(uint256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
      ethereum.Value.fromUnsignedBigInt(roundId),
    ])
  ...
  try_isFeedEnabled(aggregator: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall('isFeedEnabled', 'isFeedEnabled(address):(bool)', [
      ethereum.Value.fromAddress(aggregator),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  latestAnswer(base: Address, quote: Address): BigInt {
    let result = super.call('latestAnswer', 'latestAnswer(address,address):(int256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
  ...
  try_latestAnswer(base: Address, quote: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall('latestAnswer', 'latestAnswer(address,address):(int256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
  ...
  latestRound(base: Address, quote: Address): BigInt {
    let result = super.call('latestRound', 'latestRound(address,address):(uint256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
  ...
  try_latestRound(base: Address, quote: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall('latestRound', 'latestRound(address,address):(uint256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
  ...
  latestRoundData(base: Address, quote: Address): FeedRegistry__latestRoundDataResult {
    let result = super.call(
      'latestRoundData',
    ...
    return new FeedRegistry__latestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_latestRoundData(
    base: Address,
    quote: Address,
  ): ethereum.CallResult<FeedRegistry__latestRoundDataResult> {
    let result = super.tryCall(
      'latestRoundData',
      'latestRoundData(address,address):(uint80,int256,uint256,uint256,uint80)',
      [ethereum.Value.fromAddress(base), ethereum.Value.fromAddress(quote)],
    ...
    let value = result.value
    return ethereum.CallResult.fromValue(
      new FeedRegistry__latestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  latestTimestamp(base: Address, quote: Address): BigInt {
    let result = super.call('latestTimestamp', 'latestTimestamp(address,address):(uint256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
  ...
  try_latestTimestamp(base: Address, quote: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall('latestTimestamp', 'latestTimestamp(address,address):(uint256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
  ...
  proposedGetRoundData(
    ...
    quote: Address,
    roundId: BigInt,
  ): FeedRegistry__proposedGetRoundDataResult {
    let result = super.call(
      'proposedGetRoundData',
    ...
    return new FeedRegistry__proposedGetRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedGetRoundData(
    ...
    quote: Address,
    roundId: BigInt,
  ): ethereum.CallResult<FeedRegistry__proposedGetRoundDataResult> {
    let result = super.tryCall(
      'proposedGetRoundData',
      'proposedGetRoundData(address,address,uint80):(uint80,int256,uint256,uint256,uint80)',
      [
    ...
    let value = result.value
    return ethereum.CallResult.fromValue(
      new FeedRegistry__proposedGetRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  proposedLatestRoundData(
    base: Address,
    quote: Address,
  ): FeedRegistry__proposedLatestRoundDataResult {
    let result = super.call(
      'proposedLatestRoundData',
    ...
    return new FeedRegistry__proposedLatestRoundDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposedLatestRoundData(
    base: Address,
    quote: Address,
  ): ethereum.CallResult<FeedRegistry__proposedLatestRoundDataResult> {
    let result = super.tryCall(
      'proposedLatestRoundData',
      'proposedLatestRoundData(address,address):(uint80,int256,uint256,uint256,uint80)',
      [ethereum.Value.fromAddress(base), ethereum.Value.fromAddress(quote)],
    ...
    let value = result.value
    return ethereum.CallResult.fromValue(
      new FeedRegistry__proposedLatestRoundDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  try_typeAndVersion(): ethereum.CallResult<string> {
    let result = super.tryCall('typeAndVersion', 'typeAndVersion():(string)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  try_version(base: Address, quote: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall('version', 'version(address,address):(uint256)', [
      ethereum.Value.fromAddress(base),
      ethereum.Value.fromAddress(quote),
    ])
    if (result.reverted) {
