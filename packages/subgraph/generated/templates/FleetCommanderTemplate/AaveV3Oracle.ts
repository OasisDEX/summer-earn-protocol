...
export class AaveV3Oracle extends ethereum.SmartContract {
  static bind(address: Address): AaveV3Oracle {
    return new AaveV3Oracle('AaveV3Oracle', address)
  }

  ADDRESSES_PROVIDER(): Address {
    let result = super.call('ADDRESSES_PROVIDER', 'ADDRESSES_PROVIDER():(address)', [])

    return result[0].toAddress()
  }

  try_ADDRESSES_PROVIDER(): ethereum.CallResult<Address> {
    let result = super.tryCall('ADDRESSES_PROVIDER', 'ADDRESSES_PROVIDER():(address)', [])
    if (result.reverted) {
  ...
  try_BASE_CURRENCY(): ethereum.CallResult<Address> {
    let result = super.tryCall('BASE_CURRENCY', 'BASE_CURRENCY():(address)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  BASE_CURRENCY_UNIT(): BigInt {
    let result = super.call('BASE_CURRENCY_UNIT', 'BASE_CURRENCY_UNIT():(uint256)', [])

    return result[0].toBigInt()
  }

  try_BASE_CURRENCY_UNIT(): ethereum.CallResult<BigInt> {
    let result = super.tryCall('BASE_CURRENCY_UNIT', 'BASE_CURRENCY_UNIT():(uint256)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  getAssetPrice(asset: Address): BigInt {
    let result = super.call('getAssetPrice', 'getAssetPrice(address):(uint256)', [
  ...
  try_getAssetPrice(asset: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall('getAssetPrice', 'getAssetPrice(address):(uint256)', [
      ethereum.Value.fromAddress(asset),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  getAssetsPrices(assets: Array<Address>): Array<BigInt> {
    let result = super.call('getAssetsPrices', 'getAssetsPrices(address[]):(uint256[])', [
  ...
  try_getAssetsPrices(assets: Array<Address>): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall('getAssetsPrices', 'getAssetsPrices(address[]):(uint256[])', [
      ethereum.Value.fromAddressArray(assets),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
  ...
  getFallbackOracle(): Address {
    let result = super.call('getFallbackOracle', 'getFallbackOracle():(address)', [])

    return result[0].toAddress()
  }

  try_getFallbackOracle(): ethereum.CallResult<Address> {
    let result = super.tryCall('getFallbackOracle', 'getFallbackOracle():(address)', [])
    if (result.reverted) {
      return new ethereum.CallResult()
    }
    let value = result.value
  ...
  getSourceOfAsset(asset: Address): Address {
    let result = super.call('getSourceOfAsset', 'getSourceOfAsset(address):(address)', [
      ethereum.Value.fromAddress(asset),
    ])
  ...
  try_getSourceOfAsset(asset: Address): ethereum.CallResult<Address> {
    let result = super.tryCall('getSourceOfAsset', 'getSourceOfAsset(address):(address)', [
      ethereum.Value.fromAddress(asset),
    ])
    if (result.reverted) {
      return new ethereum.CallResult()
