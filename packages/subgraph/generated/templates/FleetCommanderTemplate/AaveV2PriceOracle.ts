...
export class AaveV2PriceOracle extends ethereum.SmartContract {
  static bind(address: Address): AaveV2PriceOracle {
    return new AaveV2PriceOracle('AaveV2PriceOracle', address)
  }
  ...
  try_getAssetsPrices(_assets: Array<Address>): ethereum.CallResult<Array<BigInt>> {
