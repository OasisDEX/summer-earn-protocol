...
export class FleetCommanderFactory extends ethereum.SmartContract {
  ...
  arks(_address: Address): FleetCommanderFactory__arksResultValue0Struct {
    ...
    return changetype<FleetCommanderFactory__arksResultValue0Struct>(result[0].toTuple())
  }

  try_arks(_address: Address): ethereum.CallResult<FleetCommanderFactory__arksResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<FleetCommanderFactory__arksResultValue0Struct>(value[0].toTuple()),
    )
  }
