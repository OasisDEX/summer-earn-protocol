...
export class FleetCommanderFactory__arksResultValue0Struct extends ethereum.Tuple {
  get ark(): Address {
    return this[0].toAddress();
  }
...
export class FleetCommanderFactory extends ethereum.SmartContract {
  static bind(address: Address): FleetCommanderFactory {
    return new FleetCommanderFactory("FleetCommanderFactory", address);
  }
  ...
  arks(_address: Address): FleetCommanderFactory__arksResultValue0Struct {
    let result = super.call("arks", "arks(address):((address,uint256))", [
      ethereum.Value.fromAddress(_address)
    ]);

    return changetype<FleetCommanderFactory__arksResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_arks(
    _address: Address
  ): ethereum.CallResult<FleetCommanderFactory__arksResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<FleetCommanderFactory__arksResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  getLastActionTimestamp(): BigInt {
    let result = super.call(
      ...
      "getLastActionTimestamp():(uint256)",
      []
    );
...
export class AdjustBufferCall__Inputs {
  ...
  get rebalanceData(): Array<AdjustBufferCallRebalanceDataStruct> {
    return this._call.inputValues[0].value.toTupleArray<
      AdjustBufferCallRebalanceDataStruct
    >();
  }
}
...
export class RebalanceCall__Inputs {
  ...
  get rebalanceData(): Array<RebalanceCallRebalanceDataStruct> {
    return this._call.inputValues[0].value.toTupleArray<
      RebalanceCallRebalanceDataStruct
    >();
  }
}
