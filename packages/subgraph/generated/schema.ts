...
export class RewardToken extends Entity {
  ...
  static loadInBlock(id: string): RewardToken | null {
    return changetype<RewardToken | null>(store.get_in_block('RewardToken', id))
  }
...
export class YieldAggregator extends Entity {
  ...
  static loadInBlock(id: string): YieldAggregator | null {
    return changetype<YieldAggregator | null>(store.get_in_block('YieldAggregator', id))
  }
  ...
  set protocolControlledValueUSD(value: BigDecimal | null) {
    if (!value) {
      ...
      this.set('protocolControlledValueUSD', Value.fromBigDecimal(<BigDecimal>value))
    }
  }
  ...
  get vaults(): VaultLoader {
    return new VaultLoader('YieldAggregator', this.get('id')!.toString(), 'vaults')
  }
...
export class UsageMetricsDailySnapshot extends Entity {
  ...
  save(): void {
    let id = this.get('id')
    assert(id != null, 'Cannot save UsageMetricsDailySnapshot entity without an ID')
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
  ...
  static load(id: string): UsageMetricsDailySnapshot | null {
    return changetype<UsageMetricsDailySnapshot | null>(store.get('UsageMetricsDailySnapshot', id))
  }
...
export class UsageMetricsHourlySnapshot extends Entity {
  ...
  save(): void {
    let id = this.get('id')
    assert(id != null, 'Cannot save UsageMetricsHourlySnapshot entity without an ID')
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
...
export class FinancialsDailySnapshot extends Entity {
  ...
  save(): void {
    let id = this.get('id')
    assert(id != null, 'Cannot save FinancialsDailySnapshot entity without an ID')
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
  ...
  static load(id: string): FinancialsDailySnapshot | null {
    return changetype<FinancialsDailySnapshot | null>(store.get('FinancialsDailySnapshot', id))
  }
...
export class Vault extends Entity {
  ...
  set rewardTokenEmissionsAmount(value: Array<BigInt> | null) {
    if (!value) {
      ...
      this.set('rewardTokenEmissionsAmount', Value.fromBigIntArray(<Array<BigInt>>value))
    }
  }
  ...
  set rewardTokenEmissionsUSD(value: Array<BigDecimal> | null) {
    if (!value) {
      ...
      this.set('rewardTokenEmissionsUSD', Value.fromBigDecimalArray(<Array<BigDecimal>>value))
    }
  }

  get dailySnapshots(): VaultDailySnapshotLoader {
    return new VaultDailySnapshotLoader('Vault', this.get('id')!.toString(), 'dailySnapshots')
  }

  get hourlySnapshots(): VaultHourlySnapshotLoader {
    return new VaultHourlySnapshotLoader('Vault', this.get('id')!.toString(), 'hourlySnapshots')
  }
...
export class VaultDailySnapshot extends Entity {
  ...
  static loadInBlock(id: string): VaultDailySnapshot | null {
    return changetype<VaultDailySnapshot | null>(store.get_in_block('VaultDailySnapshot', id))
  }

  static load(id: string): VaultDailySnapshot | null {
    return changetype<VaultDailySnapshot | null>(store.get('VaultDailySnapshot', id))
  }
...
export class VaultHourlySnapshot extends Entity {
  ...
  static loadInBlock(id: string): VaultHourlySnapshot | null {
    return changetype<VaultHourlySnapshot | null>(store.get_in_block('VaultHourlySnapshot', id))
  }

  static load(id: string): VaultHourlySnapshot | null {
    return changetype<VaultHourlySnapshot | null>(store.get('VaultHourlySnapshot', id))
  }
...
export class ActiveAccount extends Entity {
  ...
  static loadInBlock(id: string): ActiveAccount | null {
    return changetype<ActiveAccount | null>(store.get_in_block('ActiveAccount', id))
  }
...
export class TokenPrice extends Entity {
  ...
  static loadInBlock(id: Bytes): TokenPrice | null {
    return changetype<TokenPrice | null>(store.get_in_block('TokenPrice', id.toHexString()))
  }

  static load(id: Bytes): TokenPrice | null {
    return changetype<TokenPrice | null>(store.get('TokenPrice', id.toHexString()))
  }
