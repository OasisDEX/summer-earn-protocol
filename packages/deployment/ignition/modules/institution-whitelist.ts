 ...
 * - AdmiralsQuarters
 */
export const InstitutionWhitelistModule = buildModule('InstitutionWhitelistModule', (m) => {
  ...
  const configurationManager = m.contract('ConfigurationManagerWhitelist', [protocolAccessManager])
