...
//     aavePriceOracle: AavePriceOracle;
...
//     sparkDataProvider: SparkDataProvider;
//     sparkLendingPool: SparkLendingPool;
...
//     ajnaPoolFactory: ERC20PoolFactory;
...
export function getAddressesProvider(): ServiceAddresses {
    ...
    if (network == 'mainnet') {
        const addresses: ServiceAddresses = {
            ...
            AAVE_V3_DATA_PROVIDER: Address.fromString('0x7B4EB56E7CD4b454BA8ff71E4518426369a138a3'),
        ...
        const addresses: ServiceAddresses = {
            ...
            AAVE_V3_DATA_PROVIDER: Address.fromString('0x69FA688f1Dc47d4B5d8029D5a35FB7a548310654'),
        ...
        const addresses: ServiceAddresses = {
            ...
            AAVE_V3_DATA_PROVIDER: Address.fromString('0x2d8A3C5677189723C4cB8873CfC9C8976FDF38Ac'),
