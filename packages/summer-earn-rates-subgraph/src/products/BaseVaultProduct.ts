...
export abstract class BaseVaultProduct extends Product {
    ...
    getRate(currentTimestamp: BigInt): BigDecimal {
        ...
        log.error('annualizedRate: {}, previousSharePrice: {}, sharePrice: {}, priceChange: {}, timeDiff: {}, result: {}', [annualizedRate.toString(), previousSharePrice.toString(), sharePrice.toString(), priceChange.toString(), timeDiff.toString(), annualizedRate.toString()]);
