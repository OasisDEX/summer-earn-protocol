...
contract LayerZeroAdapterMessageSendForkTest is LayerZeroAdapterForkSetupTest {
    ...
    function testSendMessageViaQueue() public {
        ...
        BridgeTypes.BridgeOptions memory options =
            BridgeTypes.BridgeOptions({ specifiedAdapter: address(layerZeroAdapter), adapterParams: adapterParams });
    ...
    function testSendMessageDirectViaAdapter() public {
        ...
        (uint256 nativeFee,) =
            layerZeroAdapter.estimateFee(DEST_CHAIN_ID, address(0), 0, adapterParams, BridgeTypes.OperationType.MESSAGE);
    ...
    function testUnauthorizedAdapterCall() public {
        ...
        layerZeroAdapter.sendMessage{ value: 1 ether }(
            operationId, DEST_CHAIN_ID, keeper, message, keeper, adapterParams
        );
        vm.stopPrank();
