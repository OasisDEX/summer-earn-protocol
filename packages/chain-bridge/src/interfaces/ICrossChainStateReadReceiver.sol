...
interface ICrossChainStateReadReceiver {
     ...
     *      
     * @param resultData Encoded result data returned from the cross-chain function call.
     *        This data should be decoded using abi.decode() with the expected return type.
     * @param requestId Unique identifier for the original state read request. 
     *        Implementations should track this to match responses to requests.
     * @param sourceChainId Chain ID where the state read was executed.
     *        Should be validated against expected/trusted chains.
     *        
