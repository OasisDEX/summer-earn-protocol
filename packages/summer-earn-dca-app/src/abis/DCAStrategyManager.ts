...
// Trimmed to the entries used by the FE (createStrategy, editStrategy, pauseStrategy, resumeStrategy,
// cancelStrategy, checkUpkeep, strategyStates, strategyCommitments + relevant events and errors).
