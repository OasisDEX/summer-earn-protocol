...
<!-- AUTOGENERATED by forge doc + scripts/docs/clean-forge-docs.mjs — do not edit. Edit the NatSpec in packages/core-contracts/src/interfaces/hyperlend/IHyperlendPoolAddressesProvider.sol instead. -->

# IHyperlendPoolAddressesProvider
[Git Source](https://github.com/OasisDEX/summer-earn-protocol/blob/main/packages/core-contracts/src/interfaces/hyperlend/IHyperlendPoolAddressesProvider.sol)
...
Renamed to avoid name clash with Aave's IPoolAddressesProvider and keep life cycles separate from Aave.
