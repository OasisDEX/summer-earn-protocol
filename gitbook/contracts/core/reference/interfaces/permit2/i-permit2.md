---
description: >-
  Handles ERC20 allowance-based transfers via Permit2
---
...
current nonce thats updated on any signature based approvals. @param user The owner of the tokens
...
|----|----|-----------|
|`user`|`address`||
|`token`|`address`|The token the allowance applies to|
|`spender`|`address`|The address permitted to spend|

**Returns**

|Name|Type|Description|
|----|----|-----------|
|`amount`|`uint160`|The currently allowed amount|
|`expiration`|`uint48`|The timestamp at which the allowance expires|
|`nonce`|`uint48`|The current nonce for this owner/token/spender|
...
Exposes the EIP-712 domain separator used for signature verification


### Functions
#### DOMAIN_SEPARATOR

Returns the EIP-712 domain separator for the contract
