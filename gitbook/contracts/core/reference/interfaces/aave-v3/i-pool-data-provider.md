---
description: >-
  Interface for the Aave V3 protocol data provider (aggregated reserve and user views)
---

<!-- AUTOGENERATED by forge doc + scripts/docs/clean-forge-docs.mjs — do not edit. Edit the NatSpec in packages/core-contracts/src/interfaces/aave-v3/IPoolDataProvider.sol instead. -->

# IPoolDataProvider
[Git Source](https://github.com/OasisDEX/summer-earn-protocol/blob/main/packages/core-contracts/src/interfaces/aave-v3/IPoolDataProvider.sol)
...
## Structs
### TokenData
A token's symbol paired with its address
