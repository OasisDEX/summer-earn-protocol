---
description: >-
  Interface for the FleetCommanderDao contract, which manages asset allocation across multiple Arks
---

<!-- AUTOGENERATED by forge doc + scripts/docs/clean-forge-docs.mjs — do not edit. Edit the NatSpec in packages/core-contracts/src/interfaces/IFleetCommanderDao.sol instead. -->

# IFleetCommanderDao
[Git Source](https://github.com/OasisDEX/summer-earn-protocol/blob/main/packages/core-contracts/src/interfaces/IFleetCommanderDao.sol)

**Inherits:**
[IERC4626](../contracts/misc/max-withdraw-executor.md#ierc4626), [IFleetCommanderEvents](../events/i-fleet-commander-events.md), [IFleetCommanderErrors](../errors/i-fleet-commander-errors.md), [IFleetCommanderConfigProviderDao](./i-fleet-commander-config-provider-dao.md)
...
Only callable by the guardian or governor
