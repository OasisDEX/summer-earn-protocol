---
description: >-
  Configuration management for Whitelist-enabled fleets.
---

<!-- AUTOGENERATED by forge doc + scripts/docs/clean-forge-docs.mjs — do not edit. Edit the NatSpec in packages/core-contracts/src/interfaces/IFleetCommanderConfigProviderWhitelist.sol instead. -->

# IFleetCommanderConfigProviderWhitelist
[Git Source](https://github.com/OasisDEX/summer-earn-protocol/blob/main/packages/core-contracts/src/interfaces/IFleetCommanderConfigProviderWhitelist.sol)
...
Extension of the standard fleet configuration provider to support Operator gateways and Whitelisting.

This contract inherits `Whitelist` which provides:
