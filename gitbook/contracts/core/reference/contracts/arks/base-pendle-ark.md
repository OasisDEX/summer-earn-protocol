...
<!-- AUTOGENERATED by forge doc + scripts/docs/clean-forge-docs.mjs — do not edit. Edit the NatSpec in packages/core-contracts/src/contracts/arks/BasePendleArk.sol instead. -->

# BasePendleArk
[Git Source](https://github.com/OasisDEX/summer-earn-protocol/blob/main/packages/core-contracts/src/contracts/arks/BasePendleArk.sol)

**Inherits:**
[Ark](../ark.md), [IPendleBaseArk](../../interfaces/arks/i-pendle-base-ark.md)
...
### nextMarket
Address of the next Pendle market
...
```solidity
function _redeemFleetAsset(uint256 amount, uint256 minTokenOut) internal virtual;
```
**Parameters**
...
```solidity
function _redeemFleetAssetPostExpiry(uint256 amount, uint256 minTokenOut) internal virtual;
```
**Parameters**
