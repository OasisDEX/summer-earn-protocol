...
Returns whether the Aave reserve is active, decoded from its packed configuration bitmap
...
Returns whether the Aave reserve is paused, decoded from its packed configuration bitmap
