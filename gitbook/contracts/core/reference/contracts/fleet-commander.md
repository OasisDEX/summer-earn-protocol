...
<!-- AUTOGENERATED by forge doc + scripts/docs/clean-forge-docs.mjs — do not edit. Edit the NatSpec in packages/core-contracts/src/contracts/FleetCommander.sol instead. -->

# FleetCommander
[Git Source](https://github.com/OasisDEX/summer-earn-protocol/blob/main/packages/core-contracts/src/contracts/FleetCommander.sol)

**Inherits:**
[IFleetCommander](../interfaces/i-fleet-commander.md), [FleetCommanderConfigProvider](./fleet-commander-config-provider.md), ERC4626, [Tipper](./tipper.md), [FleetCommanderCache](./fleet-commander-cache.md), [CooldownEnforcer](../utils/CooldownEnforcer/cooldown-enforcer.md)
...
Implements IFleetCommander interface and inherits from various utility contracts
...
|----|----|-----------|
|`params`|`FleetCommanderParams`|FleetCommanderParams struct containing initialization parameters|
...
Reverts with FleetCommanderTransfersDisabled unless share transfers are enabled or the
