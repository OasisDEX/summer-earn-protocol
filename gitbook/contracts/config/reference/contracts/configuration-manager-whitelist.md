...
<!-- AUTOGENERATED by forge doc + scripts/docs/clean-forge-docs.mjs — do not edit. Edit the NatSpec in packages/config-contracts/src/contracts/ConfigurationManagerWhitelist.sol instead. -->

# ConfigurationManagerWhitelist
[Git Source](https://github.com/OasisDEX/summer-earn-protocol/blob/main/packages/config-contracts/src/contracts/ConfigurationManagerWhitelist.sol)
