...
<!-- AUTOGENERATED by forge doc + scripts/docs/clean-forge-docs.mjs — do not edit. Edit the NatSpec in packages/dutch-auction/src/DutchAuctionMath.sol instead. -->

# DutchAuctionMath
[Git Source](https://github.com/OasisDEX/summer-earn-protocol/blob/main/packages/dutch-auction/src/DutchAuctionMath.sol)

**Title:**
Dutch Auction Math Library
...
Calculates the current price based on quadratic decay

The price decreases quadratically from startPrice to endPrice over the duration
...
|Name|Type|Description|
|----|----|-----------|
|`<none>`|`uint256`|The current price based on quadratic decay|
