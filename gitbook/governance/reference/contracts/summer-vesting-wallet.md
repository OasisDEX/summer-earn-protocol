---
description: >-
  Vesting wallet with a 6-month cliff, monthly time-based release over 2 years, and optional
---
...
Appends a new performance-based vesting goal and a matching unreached flag
...
|Name|Type|Description|
|----|----|-----------|
|`goalAmount`|`uint256`|The token amount associated with the new performance goal|
